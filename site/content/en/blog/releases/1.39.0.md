...
- **GenAI and Agones**:  We've added a new <a href="https://github.com/agones-dev/agones/tree/release-1.39.0/examples/simple-genai-server" >example GenAI game server</a> that shows how to integrate Generative AI backends into your Agones game server. 
...
Check the <a href="https://github.com/agones-dev/agones/tree/release-1.39.0" >README</a> for details on features, installation and usage.
...
See <a href="https://github.com/agones-dev/agones/blob/release-1.39.0/CHANGELOG.md" >CHANGELOG</a> for more details on changes.
